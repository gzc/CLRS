...
### `Answer`
It is known as [weighted activity selection problem](https://en.wikipedia.org/wiki/Activity_selection_problem#Weighted_activity_selection_problem). It could be solved at most in O(nlg(n)) time. So here is the [solution](C16-Greedy-Algorithms/activity_selection.cpp).
