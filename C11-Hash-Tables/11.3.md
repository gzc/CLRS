...
![](http://latex.codecogs.com/gif.latex?\\sum_{j=0}^{k%20+%201}a_j%20v^j\ \\equiv%20\\sum_{j=0}^{k%20+%201}a_j%20w^j\(modp\))

其中 v > w, 得到 

![](http://latex.codecogs.com/gif.latex?\(\\sum_{j=1}^{k%20+%201}a_j%20\(v^j%20-%20w^j\)\)modp%20=%20\(\\sum_{j=1}^{k%20+%201}a_j%20\(v%20-%20w\)%20\\sum_{i=0}^{j-1}%20v_i%20w_{j%20-%20i}%20\)modp%20=%200)
